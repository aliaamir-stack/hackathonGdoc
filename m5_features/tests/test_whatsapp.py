"""
Unit Tests for the WhatsApp Alert Service.
...
from m5_features.emergency.whatsapp_alert import WhatsAppAlertService
from m5_features.models.emergency_models import EmergencyAlertResponse


class TestWhatsAppAlertService:
    """Tests for WhatsApp emergency alert service."""
    ...
    async def test_unconfigured_service_returns_not_sent(self):
        ...
        with patch.object(
            WhatsAppAlertService, '__init__', lambda self: None
        ):
    ...
    def test_message_uses_whatsapp_formatting(self):
        """Test that message uses WhatsApp *bold* formatting."""
        message = self.service._format_alert_message(
            latitude=24.8607,
            longitude=67.0011,
            situation="Test",
